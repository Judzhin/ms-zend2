...
class DealAddFormControllerTest extends \PHPUnit_Framework_TestCase {
    ...
    public function getFakeProductMapper() {
        $fakeMapper = $this->getMock('ZfDeals\Mapper\Product', array('select', 'insert'), array(), '', false
        );
    ...
    public function getFakeDealMapper() {
        $fakeMapper = $this->getMock('ZfDeals\Mapper\Deal', array('select', 'insert'), array(), '', false
        );
